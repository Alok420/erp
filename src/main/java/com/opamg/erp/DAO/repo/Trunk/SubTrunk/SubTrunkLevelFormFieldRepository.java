 ...
 */
@Repository
public interface SubTrunkLevelFormFieldRepository extends JpaRepository<SubTrunkLevelFormField, Long> {
    List<SubTrunkLevelFormField> findByLevelForm(SubTrunkLevelForm form);
