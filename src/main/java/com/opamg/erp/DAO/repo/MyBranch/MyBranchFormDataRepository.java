 ...
 */
@Repository
public interface MyBranchFormDataRepository extends JpaRepository<MyBranchFormData, Long> {

   List<MyBranchFormData> findByLevelForm(MyBranchLevelForm levelForm);
