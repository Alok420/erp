...
public class SubRoleFormData {
   ...
   private RoleFormData roleFormData;
   ...
   public SubRoleFormData() {
   }

   public SubRoleFormData(SubRoleLevelForm levelForm, String jsonvalue) {
...
//    str = str.replace("\"", "\\\"");
   ...
   public RoleFormData getRoleFormData() {
      return roleFormData;
   }

   public void setRoleFormData(RoleFormData RoleFormData) {
