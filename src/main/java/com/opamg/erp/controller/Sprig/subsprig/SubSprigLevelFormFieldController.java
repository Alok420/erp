 ...
 */
@Controller
public class SubSprigLevelFormFieldController {

  @Autowired
  SubSprigLevelFormFieldService levelFormFieldService;

  @PostMapping("subsprig/level-form-field/create")
  ModelAndView saveLevelFormFields(@Valid SubSprigLevelFormField levelFormField, BindingResult br, ModelMap map, HttpServletRequest req) {
  ...
  @GetMapping(value = "subsprig/level-form-field/delete")
