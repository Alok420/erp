 ...
 */
@Controller
public class SubMyBranchLevelFormFieldController {

  @Autowired
   SubMyBranchLevelFormFieldService levelFormFieldService;

   @PostMapping("submybranch/level-form-field/create")
   ModelAndView saveLevelFormFields(@Valid SubMyBranchLevelFormField levelFormField, BindingResult br, ModelMap map, HttpServletRequest req) {
   ...
   @GetMapping(value = "submybranch/level-form-field/delete")
