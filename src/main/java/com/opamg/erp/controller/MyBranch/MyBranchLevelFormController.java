 ...
 */
@Controller
public class MyBranchLevelFormController {
  ...
  @Autowired
   ...
   @PostMapping("mybranch/level-form/create")
   ModelAndView saveLevelForm(@Valid MyBranchLevelForm levelForm, BindingResult br, ModelMap map, HttpServletRequest req) {
   ...
   @GetMapping(value = "mybranch/level-from/delete")
  ModelAndView deleteForm(@RequestParam long id,HttpServletRequest req) {
   ...
   @GetMapping(value = "mybranch/settings/forms")
  public ModelAndView form(HttpServletRequest request) {
    ...
    modelAndView.addObject("LevelForms", levelFormService);
     ...
     modelAndView.setViewName("mybranch/MyBranchFormDataSetting");
    return modelAndView;
  }
