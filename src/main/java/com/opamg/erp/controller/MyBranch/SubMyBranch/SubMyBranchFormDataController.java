...
@Controller
@RestController
public class SubMyBranchFormDataController implements CommonDeclaration {

   private final String dir = file_dir + "SubMyBranch";

   @Autowired
   SubMyBranchFormDataService dataService;
   ...
   @PostMapping("submybranch/level-form-data/create")
   JSONObject saveFormData(HttpServletRequest request) {
	...
	ex.printStackTrace();
      ...
      SubMyBranchFormData formdata = new SubMyBranchFormData();

      long l = Long.parseLong(String.valueOf(jsonObj.get("levelFormId")));
      long mybranchFormDataid = Long.parseLong(String.valueOf(jsonObj.get("formData")));

      formdata.setLevelForm(formService.getRepository().findById(l).get());
      formdata.setFormData(mybranchFormDataService.getRepository().findById(mybranchFormDataid).get());
...
//
//      long l = Long.parseLong(String.valueOf(jsonObj.get("levelFormId")));
//      long mybranchFormDataid = Long.parseLong(String.valueOf(jsonObj.get("mybranchFormData")));
//
//      formdata.setLevelForm(formService.getRepository().findById(l).get());
//      formdata.setMyBranchFormData(mybranchFormDataService.getRepository().findById(mybranchFormDataid).get());
//
//      jsonObj.remove("levelFormId");
//      jsonObj.remove("mybranchFormData");
//
//      formdata.setJsonvalue(jsonObj.toJSONString());
//      dataService.getRepository().save(formdata);
//
...
//      return jsonObj;
   ...
   @PostMapping("submybranch/level-form-data/update")
   JSONObject updateFormData(HttpServletRequest request) {
	...
	ex.printStackTrace();
      ...
      SubMyBranchFormData formdata = dataService.getRepository().findById(Long.parseLong(String.valueOf(jsonObj.get("id")))).get();
   ...
   @GetMapping(value = "submybranch/level-form-data/delete/")
