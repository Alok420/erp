 ...
 */
@Controller
public class SubSeedLevelFormFieldController {

  @Autowired
  SubSeedLevelFormFieldService levelFormFieldService;

   @PostMapping("subseed/level-form-field/create")
  ModelAndView saveLevelFormFields(@Valid SubSeedLevelFormField levelFormField, BindingResult br, ModelMap map, HttpServletRequest req) {
   ...
   @GetMapping(value = "subseed/level-form-field/delete")
