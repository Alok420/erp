 ...
 */
@Controller
public class SubTrunkLevelFormFieldController {

  @Autowired
  SubTrunkLevelFormFieldService levelFormFieldService;

   @PostMapping("subtrunk/level-form-field/create")
  ModelAndView saveLevelFormFields(@Valid SubTrunkLevelFormField levelFormField, BindingResult br, ModelMap map, HttpServletRequest req) {
   ...
   @GetMapping(value = "subtrunk/level-form-field/delete")
