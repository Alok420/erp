                ...
                <div class="container-fluid" >
                    <div class="row" style="background-color: #CCFFCC; margin-bottom: 10px;padding: 10px;padding-bottom: 2px;">
                        <div id="formBox"  style="width: 100%;">
                            ...
                            <form method="POST" action="" id="sprigfdupdate${fn:replace(form.level.chart.name,' ', '_')}${form.level.id}_${i.index}${row.id}" enctype="multipart/form-data">
                                ...
                                <div class="row form-group">
                                    <div class="col-lg-3">
                                        <input type="button" onclick="updateSprigData('sprigfdupdate${fn:replace(form.level.chart.name,' ', '_')}${form.level.id}_${i.index}${row.id}', 'saveSprigFormDataupdatebox${fn:replace(form.level.chart.name,' ', '_')}${form.level.id}_${i.index}${row.id}')"  value="Save" class="btn btn-block btn-outline-success">

                                    </div>
                                    <div class="col-lg-1">
                                        <div style="color: black;" id="saveSprigFormDataupdatebox${fn:replace(form.level.chart.name,' ', '_')}${form.level.id}_${i.index}${row.id}"></div>
                                    </div>
                                    <div class="col-lg-8">
                                                            ...
                                                            <div class="modal-body">
                                                                <form action="../subsprig/main/create" onsubmit="return validaterRootChartForm()"  method="POST" enctype="multipart/form-data">
                                                                    ...
                                                                    <div>
                                                                        ...
                                                                        <input type="hidden" name="sprigLevelForm" value="${form.id}">
                                                                    </div>
                                                                    <div>
                                                                            ...
                                                                            <div id="formBox"  style="padding: 0px; width: 100%;">
                                                                                <c:forEach items="${SubFormService.findByLevel(sublevel)}" var="subform" varStatus="subformindex">
                                                                                    ...
                                                                                    <form method="POST" action="" id="formdataupdate${form.id}${sublevel.id}${subform.id}${row.id}">
                                                                                        <div class="row form-group">
                                                                                            <div class="col-lg-12">
                                                                                                <input type="hidden" class="sprigFormDataOptionList2" name="sprigFormData" value="${row.id}">
                                                                                            </div>
                                                                                        </div>
                                                                                        <div class="row form-group">
                                                                                        ...
                                                                                        <div class="row form-group">
                                                                                            <div class="col-lg-3">
                                                                                                <input type="button" onclick="saveSubSprigData2('formdataupdate${form.id}${sublevel.id}${subform.id}${row.id}')" value="Save" class="btn btn-block btn-outline-success">
                                                                                            </div>
                                                                                            <div class="col-lg-3">
                                                                                                <div id="saveSubSprigFormData2" style="color: black;"></div>
                                                                                            </div>
                                                                                            <div class="col-lg-6">
                                                                                    ...
                                                                                    <div style="background-color: #003366; padding: 5px;border-radius: 5px;">
                                                                                        <table id="subtable${sublevel.id}${subform.id}${row.id}" class="display nowrap" style="width:100%;color: black;" >
                                                                                            ...
                                                                                            <tbody>
                                                                                            <c:forEach items="${SubFormDataService.getRepository().findBySprigFormData(row)}" var="subrow" varStatus="subrindex">
                                                                                                <tr>
                                                                                                    <td>${subrow.id}</td>
                                                                                                <c:forEach items="${SubLevelFormFieldService.getRepository().findByLevelForm(subform)}" var="suballField" varStatus="subj">
                                                                                                    <td>
                                                                                                ...
                                                                                                <td>${subrow.sprigFormData.id}</td>
                                                                                                <td>
                                                                                                    <a href="../subsprig/level-form-data/delete/?id=${subrow.id}" onclick="return confirm('Are you sure? you want to delete this record')" class="btn btn-danger btn-sm"><i class="fa fa-trash-o"></i></a>
