		...
		<div class="row">
		   <div class="col-sm-11">
			...
			<div id="formBox"  style="width: 100%; ">
			   ...
			   <form method="POST" action="" id="sprigfd${form.id}${level.id}" enctype="multipart/form-data">
				...
				<c:forEach items="${LevelFormFieldService.getRepository().findByLevelForm(form)}" var="field" varStatus="">
				   <c:choose>
					...
					<div class="col-lg-2 mb-2">
					   <strong class="pl-2" style="font-size: 12px;">${field.name}</strong>
					   <select id="sprigfd${form.id}${level.id}_dropdown_field_id_${field.id}" onchange="getDropDownData(this, '${field.default_value}',${form.id},${field.id}, 'sprigfd${form.id}${level.id}_dropdown_field_id_')" class="bg-focus form-control" data="${field.default_value}" required name="${field.name}" placeholder="${field.placeholder}" autocomplete="off" style="height: 35px;">
					      <option>Select any one</option>
					      <c:choose>
						<c:when test="${relational_ids[0] eq 'Sprig'}">
						   <c:forEach items="${SprigFormDataService.findByLevelForm(SprigLevelForm.findByLevel(SprigLevel.findOneById(relational_ids[2])).get(0))}" var="obj" varStatus="i">
			      ...
			      <div class="row form-group">
				<div class="col-lg-3">
				   <input type="button" onclick="saveSprigData('sprigfd${form.id}${level.id}')"  value="Save" class="btn btn-block btn-outline-success">
				</div>
				<div class="col-lg-1">
				   <div style="color: black;" id="saveSprigFormData">
			   ...
			   <div class="modal" id="${fn:replace(form.level.chart.name,' ', '_')}${form.level.id}_${i.index}">
				...
				<div class="modal-content">
				   ...
				   <div class="modal-body">
				      <form action="../sprig/level-form-field/create"  method="POST" enctype="multipart/form-data">
			   ...
			   <div class="container-fluid">
				...
				<nav class="col-sm-1" id="myScrollspy" style="background-color: #1560BD;">
				   <ul class="nav nav-pills flex-column">
				      <c:forEach items="${SubMainService.findAllBySprigLevelForm(form)}" var="submain">
					<c:choose>
					...
					<div class="modal" id="addsubmainmodal${form.id}">
					   <div class="modal-dialog">
						...
						<!-- Modal body -->
						<div class="modal-body">
						   <form action="./../subsprig/main/create" onsubmit="return validaterRootChartForm()"  method="POST" enctype="multipart/form-data">
					   ...
					   <ul class="nav nav-tabs">
						...
						<div id="subaddlevel${submain.id}${form.id}${sublastlevel.id}" class="modal fade" role="dialog">
						   <div class="modal-dialog">
							...
							<div class="modal-body">
							   <form action="../subsprig/level/create" onsubmit="return validateLevelForm()" method="POST" enctype="multipart/form-data">
						   ...
						   <div>
							...
							<div id="subaddform${form.id}${sublevel.id}" class="modal fade" role="dialog">
							   <div class="modal-dialog">
								...
								<div class="modal-body">
								   <form onsubmit="validateLevelForm()" action="../subsprig/level-form/create" method="POST" enctype="multipart/form-data">
							...
							<div class="row" style="">
							   ...
							   <div id="formBox"  style="padding: 0px; width: 100%;">
								...
								<form method="POST" action="" id="formdata${form.id}${sublevel.id}" style="border:thin solid #003366; margin-bottom: 10px;padding: 5px;border-radius: 5px;">
								   <div class="row form-group">
								      <div class="col-lg-12">
									<input type="hidden" class="sprigFormDataOptionList" name="sprigFormData" id="sprigFormDataOptionList">
									<%--    <select class="form-control sprigFormDataOptionList" required name="sprigFormData" id="sprigFormDataOptionList">
								   ...
								   <div class="row form-group">
									...
									<c:choose>
									   ...
									   <c:when test="${subfield.type eq 'dropdown' and subfield.default_value_type eq 'select_parent'}">
									      ...
									      <div class="col-lg-2 mb-2">
										<strong class="pl-2" style="font-size: 12px;">${subfield.name}</strong>
										<select id="sprigfd${subform.id}${sublevel.id}_dropdown_field_id_${subfield.id}" onchange="getSubSprigDropDownData(this, '${subfield.default_value}',${subform.id},${subfield.id}, 'sprigfd${subform.id}${sublevel.id}_dropdown_field_id_')" class="bg-focus form-control" data="${subfield.default_value}" required name="${subfield.name}" placeholder="${subfield.placeholder}" autocomplete="off" style="height: 35px;">
										   <option>Select any one</option>
										   <c:choose>
										      <c:when test="${relational_ids[0] eq 'Sprig'}">
											<c:forEach items="${SprigFormDataService.findByLevelForm(SprigLevelForm.findByLevel(SprigLevel.findOneById(relational_ids[2])).get(0))}" var="obj" varStatus="i">
								   ...
								   <div class="row form-group">
								      <div class="col-lg-3">
									<input type="button" onclick="saveSubSprigData('formdata' +${form.id}${sublevel.id})" value="Save" class="btn btn-block btn-outline-success">
								      </div>
								      <div class="col-lg-3" >
									<div id="saveSubSprigFormData" style="color: black;"></div>
								      </div>
								      <div class="col-lg-6" >
								...
								<div class="modal" id="sub${fn:replace(subform.level.chart.name,' ', '_')}${subform.level.id}_${i.index}">
								   <div class="modal-dialog">
									...
									<div class="modal-body">
									   <form action="../subsprig/level-form-field/create"  method="POST" enctype="multipart/form-data">
