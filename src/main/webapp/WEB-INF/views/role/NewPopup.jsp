                ...
                <div class="modal-body">
                    <div class="container-fluid" >
                        <div class="row">
                            <div class="col-sm-11">
                                <div class="row" style="background-color: #CCFFCC; margin-bottom: 10px;padding: 10px;padding-bottom: 2px">
                                    <div id="formBox"  style="width: 100%; ">
                                        ...
                                        <form method="POST" action="" id="rolefd${form.id}${level.id}" enctype="multipart/form-data">
                                            <div class="row form-group" style="margin: 0px 10px;">
                                                ...
                                                <input style="height: 20px;" onkeyup="popupBoxLevelDropDownChange('popupBoxLevelDropDown${fn:replace(form.level.chart.name,' ', '_')}${form.level.id}_${i.index}', '${form2 eq  null?0:form2.id}', 'rolefd${form.id}${level.id}')" id="popupBoxLevelDropDown${fn:replace(form.level.chart.name,' ', '_')}${form.level.id}_${i.index}" type="text">
                                            </div>
                                                ...
                                                <c:forEach items="${LevelFormFieldService.getRepository().findByLevelForm(form)}" var="field" varStatus="">
                                                    <c:choose>
                                                        ...
                                                        <c:when test="${field.type eq 'dropdown' and field.default_value_type eq 'select_parent'}">
                                                            ...
                                                            <div class="col-lg-2 mb-2">
                                                                <strong class="pl-2" style="font-size: 12px;">${field.name}</strong>
                                                                <select id="rolefd${form.id}${level.id}_dropdown_field_id_${field.id}" onchange="getDropDownData(this, '${field.default_value}',${form.id},${field.id}, 'rolefd${form.id}${level.id}_dropdown_field_id_')" class="bg-focus form-control" data="${field.default_value}" required name="${field.name}" placeholder="${field.placeholder}" autocomplete="off" style="height: 35px;">
                                                                    <option>Select any one</option>
                                                                    <c:choose>
                                                                        <c:when test="${relational_ids[0] eq 'Role'}">
                                                                            <c:forEach items="${RoleFormDataService.findByLevelForm(RoleLevelForm.findByLevel(RoleLevel.findOneById(relational_ids[2])).get(0))}" var="obj" varStatus="i">
                                            ...
                                            <input type="hidden" name="formData" id="levelFormDataId">

                                            <div class="row form-group">
                                                <div class="col-lg-3">
                                                    <input type="button" onclick="saveRoleData('rolefd${form.id}${level.id}')"  value="Save" class="btn btn-block btn-outline-success">
                                                </div>
                                                <div class="col-lg-1">
                                                    <div style="color: black;" id="saveRoleFormData">
                                        ...
                                        <div class="modal" id="${fn:replace(form.level.chart.name,' ', '_')}${form.level.id}_${i.index}">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="../role/level-form-field/create"  method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="row">
                                                <nav class="col-sm-1" id="myScrollspy" style="background-color: #1560BD;">
                                                    <ul class="nav nav-pills flex-column">
                                                        <c:forEach items="${SubMainService.findAllByRoleLevelForm(form)}" var="submain">
                                                            <c:choose>
                                                            ...
                                                            <div class="modal" id="addsubmainmodal${form.id}">
                                                                <div class="modal-dialog">
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <!-- Modal body -->
                                                                        <div class="modal-body">
                                                                            <form action="./../subrole/main/create" onsubmit="return validaterRootChartForm()"  method="POST" enctype="multipart/form-data">
                                                                        ...
                                                                        <div id="subaddlevel${submain.id}${form.id}${sublastlevel.id}" class="modal fade" role="dialog">
                                                                            <div class="modal-dialog">
                                                                                ...
                                                                                <div class="modal-content">
                                                                                    ...
                                                                                    <div class="modal-body">
                                                                                        <form action="../subrole/level/create" onsubmit="return validateLevelForm()" method="POST" enctype="multipart/form-data">
                                                                                    ...
                                                                                    <div id="subaddform${form.id}${sublevel.id}" class="modal fade" role="dialog">
                                                                                        <div class="modal-dialog">
                                                                                            ...
                                                                                            <div class="modal-content">
                                                                                                ...
                                                                                                <div class="modal-body">
                                                                                                    <form onsubmit="validateLevelForm()" action="../subrole/level-form/create" method="POST" enctype="multipart/form-data">
                                                                                        ...
                                                                                        <div id="formBox"  style="padding: 0px; width: 100%;">
                                                                                            <c:forEach items="${SubFormService.findByLevel(sublevel)}" var="subform" varStatus="subformindex">
                                                                                                ...
                                                                                                <form method="POST" action="" id="formdata${form.id}${sublevel.id}" style="border:thin solid #003366; margin-bottom: 10px;padding: 5px;border-radius: 5px;">
                                                                                                    <div class="row form-group">
                                                                                                        <div class="col-lg-12">
                                                                                                            <input type="hidden" class="roleFormDataOptionList" name="roleFormData" id="roleFormDataOptionList">
                                                                                                            <%--    <select class="form-control roleFormDataOptionList" required name="roleFormData" id="roleFormDataOptionList">
                                                                                                        ...
                                                                                                        <c:forEach items="${SubLevelFormFieldService.getRepository().findByLevelForm(subform)}" var="subfield" varStatus="">
                                                                                                            <c:choose>
                                                                                                                ...
                                                                                                                <c:when test="${subfield.type eq 'dropdown' and subfield.default_value_type eq 'select_parent'}">
                                                                                                                    ...
                                                                                                                    <div class="col-lg-2 mb-2">
                                                                                                                        <strong class="pl-2" style="font-size: 12px;">${subfield.name}</strong>
                                                                                                                        <select id="rolefd${subform.id}${sublevel.id}_dropdown_field_id_${subfield.id}" onchange="getSubRoleDropDownData(this, '${subfield.default_value}',${subform.id},${subfield.id}, 'rolefd${subform.id}${sublevel.id}_dropdown_field_id_')" class="bg-focus form-control" data="${subfield.default_value}" required name="${subfield.name}" placeholder="${subfield.placeholder}" autocomplete="off" style="height: 35px;">
                                                                                                                            <option>Select any one</option>
                                                                                                                            <c:choose>
                                                                                                                                <c:when test="${relational_ids[0] eq 'Role'}">
                                                                                                                                    <c:forEach items="${RoleFormDataService.findByLevelForm(RoleLevelForm.findByLevel(RoleLevel.findOneById(relational_ids[2])).get(0))}" var="obj" varStatus="i">
                                                                                                    ...
                                                                                                    <div class="row form-group">
                                                                                                        <div class="col-lg-3">
                                                                                                            <input type="button" onclick="saveSubRoleData('formdata' +${form.id}${sublevel.id})" value="Save" class="btn btn-block btn-outline-success">
                                                                                                        </div>
                                                                                                        <div class="col-lg-3" >
                                                                                                            <div id="saveSubRoleFormData" style="color: black;"></div>
                                                                                                        </div>
                                                                                                        <div class="col-lg-6" >
                                                                                                ...
                                                                                                <div class="modal" id="sub${fn:replace(subform.level.chart.name,' ', '_')}${subform.level.id}_${i.index}">
                                                                                                    <div class="modal-dialog">
                                                                                                        <div class="modal-content">
                                                                                                            ...
                                                                                                            <div class="modal-body">
                                                                                                                <form action="../subrole/level-form-field/create"  method="POST" enctype="multipart/form-data">
                            ...
                            <div class="col-sm-1 popuprightsidebar" style="background-color: white;">
                                <ul>
